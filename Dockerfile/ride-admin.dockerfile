...
ENV REDIS_HOST='redis.kke2mj.ng.0001.eun1.cache.amazonaws.com:6379'
ENV REDIS_PORT=6379
ENV REDIS_USERNAME=
ENV REDIS_PASSWORD=
ENV REDIS_TLS=
...
ENV AWS_ACCESS_KEY_ID = AKIA6GBMGWAZC6BOMRBU
ENV AWS_SECRET_ACCESS_KEY = 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
ENV AWS_REGION = eu-north-1 
ENV AWS_BUCKET_NAME=k-taxi
